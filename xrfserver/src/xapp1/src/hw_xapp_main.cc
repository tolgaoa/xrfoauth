...
int main(int argc, char *argv[]){
	...
	mdclog_write(MDCLOG_INFO, "Test5");
	sleep(10);

	mdclog_write(MDCLOG_INFO, "Test6");
	...
	mdclog_write(MDCLOG_INFO, "Test7");
	...
	mdclog_write(MDCLOG_INFO, "Test8");
	hw_xapp->start_xapp_receiver(std::ref(*mp_handler));
	mdclog_write(MDCLOG_INFO, "Test9");
	sleep(1);
	mdclog_write(MDCLOG_INFO, "Test10");
	...
	//hw_xapp->shutdown();
 	...
 	while(1){
		mdclog_write(MDCLOG_INFO, "TestINF");
		sleep(5);
	}
