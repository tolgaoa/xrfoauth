...
private:
    ...
    /// 
    /// </remarks>
    /// <param name="targetxAppService">service offered by the target xApp</param>
    /// <param name="reqestingxAppService">service offered by the requesting xApp</param>
    /// <param name="acceptEncoding">Accept-Encoding, described in IETF RFC 7231 (optional, default to &quot;&quot;)</param>
    virtual void x_app_disc_inst(const org::openapitools::server::model::Pistache::Optional<XAppService> &targetxAppService, const org::openapitools::server::model::Pistache::Optional<XAppService> &reqestingxAppService, const Pistache::Optional<Pistache::Http::Header::Raw> &acceptEncoding, Pistache::Http::ResponseWriter &response) = 0;
