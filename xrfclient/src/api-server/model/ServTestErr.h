 ...
 * ServTestErr.h
 *
 * Error returned in the service testresponse message
 */

#ifndef ServTestErr_H_
#define ServTestErr_H_
...
public:
    ...
    bool operator==(const ServTestErr& rhs) const;
    bool operator!=(const ServTestErr& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const ServTestErr& o);
    friend void from_json(const nlohmann::json& j, ServTestErr& o);
protected:
    std::string m_Error;
